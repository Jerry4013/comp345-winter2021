...
string ContriesNameFromMap[100];
...
//            }
            ...
            for(int i = 0;i<bordersStartLine-countriesStartLine-2 ; i++){
                if(ContriesNameFromMap[i]=="NONE"){
                    ContriesNameFromMap[i]=Countrybuffer[1];
                    break;
                }
            }
            for(int i = 0;i<bordersStartLine-countriesStartLine-2 ; i++){
...
//=============================================conquest rile reader=====================================
ConquestFileReader::ConquestFileReader() {
    inputConquestFileName = "emptyFile";
}
ConquestFileReader::ConquestFileReader(string fileName) {
    this->inputConquestFileName = fileName;
    conquestLoadMap(fileName);
}

ConquestFileReader::~ConquestFileReader() {
    inputConquestFileName.clear();
}

string ConquestFileReader::getInputConquestFileName() {
    return inputConquestFileName;
}

void ConquestFileReader::setInputConquestFileName(string fileName) {
    inputConquestFileName = fileName;
}

void ConquestFileReader::conquestLoadMap(string fileName) {
...
ConquestFileReaderAdapter::ConquestFileReaderAdapter(string fileName, int arraySize) : MapLoader(), conquestFileReader(ConquestFileReader(fileName)) {
